...
海名：我也在想，我的脑袋里是不是也有点老学究的古板，一面喜欢幻想题材，另一面，又偏要找出传说和这些可以触及的东西之间的联系。#portrait: haiming_3_smile
...
海名：我相信的。#profile: hide #portrait: haiming_3_squint
...
海名：不过，我得要你的一个秘密来交换。#portrait: haiming_1_squint #profile: hide
+[错过bonus]->sure
+[危险的职业]->danger
...
==danger==
我：………… #profile: painter_alert #bgm: fade_0.1_0.1
海名：……也不用这么如临大敌。差点忘记了，你也是个心思重的家伙，比起“秘密”，或许更应该叫做“有趣的事实”？#profile: hide #bgm: fade_1_1
...
海名：痕迹学，就是研究物品因置换而消失后所留下的痕迹的学说。#portrait: haiming_3_pushGlass #portrait: haiming_3_norm
海名：万物消失之后必将留下痕迹，只是痕迹常常被人遗忘。而追寻痕迹，却是人重新获得存在的自主性的方式。
捕捉：【痕迹学家】
海名：除了研究作为痕迹载体的物品——比如说，你的丈夫消失之后留在浴室的刮胡刀——，我们也研究留下痕迹的行为，研究遗忘的机制。
海名：学界也是在一年前克莱拉·崔西那篇《论痕迹研究在逆转置换事故中的应用》之后才正式承认痕迹学的存在的，在那之前，所有人都当我们是妄想症和闭门造车的偏执狂。#portrait: haiming_3_eyeClosed #profile: hide
海名：但为了写出这篇数据详实的论文，崔西几乎掏空了自己的一切，又通过痕迹把一切都寻了回来……真的是个奇迹。
海名：现在的待遇好多了。其实，我离开的这几天是去参加学术峰会了，还是头一次，痕迹学家能聚在一起。#portrait: haiming_3_squint
海名：会场是Carpe Diem资助的，也许是在我们身上发现了某种商业价值吧，他们愿意分享部分数据作研究。我实在没办法信任那个公司，但至少现状是有利于我们的。#portrait: haiming_3_norm
我：……………… #profile: painter_side 
我：（还好我没说出口。太尴尬了。）
我：（人家不是自封的……………………）#profile: painter_sideSweat
我：原来如此，这也算是纹身实践之余的一种学术上的实践了。……你是个跨学科人才。#profile: painter_norm
我：这样想的话，纹身其实也是一种痕迹？#profile: painter_stunned #portrait: haiming_3_pushGlass
...
海名：我覆盖过最多的图案，其实是文字。 #profile: hide #portrait: haiming_3_norm
海名：有一些是名字。#portrait: haiming_3_pushGlass
我：总觉得有点恐怖。#profile: painter_side
我：曾经珍重到愿意刻在身上的东西，突然有一天就不再拥有含义了。
海名：只有留在真皮层的痕迹会不断地提醒你，过去曾经存在过。#profile: hide #portrait: haiming_1_idle #portrait: haiming_1_smile
海名：这大概是一种很令人不安的感受吧。#portrait: haiming_1_idle #portrait: haiming_1_sad
我：……我能理解。#profile: painter_side #bgm: fade_1_0.3
海名：嗯……咦？#profile: hide #portrait: haiming_1_smile 
我：我的秘密。交换。#profile: painter_side #bgm: 日常_1
海名：洗耳恭听。#profile: hide #portrait: haiming_1_squint
我：*递出鱼鳞*这就是我的痕迹。#profile: painter_norm
海名：鱼鳞？#profile: hide #portrait: haiming_2_idle #portrait: haiming_2_frown
 ：海名小心翼翼地接过鳞片。【手上动画变化】#portrait: haiming_2_think
...
我：为了……什么？
海名：作为纹身师，我的工作是覆盖痕迹。作为痕迹学家，我只会刨根问底。画家，你希望我怎么帮助你呢？#bgm: fade_0.2_1
+[痕迹学家（+追忆）]->findOut
+[纹身师（+遗忘）]->cover
...
海名：不逗你了。回到“那条鱼”的事情，就说你从鱼贩手里买了这条鱼，你所遗忘的故事，和鱼贩遗忘的是不同的。
...
我：占位角色？
海名：人的脑袋是很自我的，归根结底，事物和自己的联系才是记忆的关键。
