INCLUDE ../global.ink
Me：It's still a rough draft, I can't take your money.#bgm: 日常 #profile: painter_mournful
Seanamae：You'd see it as unfinished, but it's actually quite specific. There's no problem for me to change it into a tattoo design.#profile: haiming_yinyang
...
Seanamae：Hey, don't overthink. It's just that I have confidence in your work. I'm sure that with your design, I'm gonna double -- no, triple what I've just paid you.#profile: haiming_seeYouKnow
...
Meng：*Silently turns head* #profile: meng_noWord
...
Me：Thank you. (I could <color=green>come here</color> for <color=green>completing the draft</color>, or to <color=green>learn more about the mermaid</color>, anytime the next few days.）#profile: painter_eyeClosed
